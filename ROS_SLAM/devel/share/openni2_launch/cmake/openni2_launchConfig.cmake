...
if("TRUE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /home/tongsir/ROS_SLAM/src/depth_camera/openni2_launch)
  set(openni2_launch_DEVEL_PREFIX /home/tongsir/ROS_SLAM/devel)
  ...
  set(openni2_launch_INSTALL_PREFIX /home/tongsir/ROS_SLAM/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tongsir/ROS_SLAM/src/depth_camera/openni2_launch/${idir}'.  ${_report}")
    endif()
